namespace Test01_02 {
    internal class Program {
        ...
        private static void Exercise03(int[] numbers) {
            var upNum = numbers.OrderBy(n => n);
            foreach (var item in upNum) {
        ...
        private static void Exercise04(int[] numbers) {
            var selnum = numbers.Where(n => 10 <= n && n <= 50);
            foreach (var item in selnum) {
                Console.WriteLine(item);
            }
        }
        ...
        private static void Exercise05(List<string> cities) {
            var cntCities = cities.Where(x => x.Contains('n')).Count();
            Console.WriteLine(cntCities);
        }
        ...
        private static void Exercise07(List<string> cities) {
           var upCities = cities.OrderBy(x => x);
            foreach ( var item in upCities) {
                Console.WriteLine(item);
            }
        }
        ...
        private static void Exercise09(List<string> cities) {
            foreach (var item in cities.OrderBy(x => x.Length)) {
